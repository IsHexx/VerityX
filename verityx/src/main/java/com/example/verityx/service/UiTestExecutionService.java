...
public interface UiTestExecutionService {
     ...
     * @return 分页结果
     */
    PageResult<UiTestExecutionDTO> getExecutionList(int page, int pageSize, String keyword, String status, String executionType);
     ...
     * @return 分页结果
     */
    PageResult<UiTestExecutionDTO> getExecutionQueue(String status, int page, int pageSize);
